...
import "./ProduitMagasinQuery.css"
...
export interface ProductType{
    ...
    <div className="row height">
      <div className="col-md-6">
        <div className="form ">
          ...
          <input type="text" onChange={handelSearche} className="form-control form-input" placeholder="Recherche un produit , ref .." />
  ...
  product.filter((pro) => {
    ...
    product.filter((pro) => {
      ...
      <p>Malheureusement, on na pas ce produit pour l’instant.</p><br />
